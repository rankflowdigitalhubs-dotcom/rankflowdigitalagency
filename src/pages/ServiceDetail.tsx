    ...
    <>
      ...
      <section className="container-x py-16">
        <div className="grid gap-12 lg:grid-cols-2">
          <div className="reveal">
            ...
            <h2 className="mt-4 text-3xl font-bold text-white">Everything in this engagement</h2>
            <p className="mt-4 text-slate-400">A clear scope with no surprises. Here’s exactly what you get:</p>
          ...
          <div className="reveal reveal-delay-2">
            <div className="grad-border rounded-3xl">
              <div className="rounded-3xl bg-gradient-to-br from-ink-800 to-ink-900 p-8">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-500/20 to-accent-500/10 text-brand-300">
                  <service.icon className="h-8 w-8" />
                </div>
                <h3 className="mt-5 text-xl font-semibold text-white">{service.tagline}</h3>
      ...
      <section className="container-x py-16">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold text-white reveal reveal-delay-1">Our {service.title} process</h2>
        </div>
          ...
          {service.process.map((p, i) => (
            <div key={p.title} className={`grad-border lift reveal reveal-delay-${(i % 3) + 1}`}>
              <div className="rounded-3xl bg-white/[0.03] p-7">
                <div className="font-display text-4xl font-bold text-white/10">0{i + 1}</div>
      ...
      <section className="container-x py-16">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-3xl font-bold text-white reveal reveal-delay-1">{service.title} questions</h2>
        </div>
        <div className="mt-10">
