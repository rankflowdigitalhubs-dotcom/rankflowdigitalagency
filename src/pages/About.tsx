...
export default function About() {
  return (
    <>
      ...
      <section className="container-x py-16">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="reveal">
            ...
            <h2 className="mt-4 text-3xl font-bold text-ink-950 sm:text-4xl">Built by marketers who got tired of empty promises</h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div key={v.title} className={`glass lift p-8 reveal reveal-delay-${i + 1}`}>
              ...
              <h3 className="mt-5 text-xl font-semibold text-ink-950">{v.title}</h3>
      ...
      <section className="container-x py-16">
        <div className="grad-border rounded-3xl">
          <div className="grid grid-cols-2 gap-8 rounded-3xl bg-slate-50/60 p-10 lg:grid-cols-4">
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {whyChooseUs.map((w, i) => (
            <div key={w.title} className={`glass lift p-7 reveal reveal-delay-${(i % 3) + 1}`}>
              <h3 className="text-lg font-semibold text-ink-950">{w.title}</h3>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={t.label} className={`glass p-6 text-center reveal reveal-delay-${i + 1}`}>
              <t.icon className="mx-auto h-8 w-8 text-brand-600" />
              <div className="mt-3 font-display text-2xl font-bold text-ink-950">{t.label}</div>
              <div className="text-sm text-ink-600">{t.sub}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="container-x py-12">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl font-bold text-ink-950 reveal reveal-delay-1">What we do</h2>
          <p className="mt-3 text-ink-600">Explore our full range of SEO and digital marketing services.</p>
        </div>
