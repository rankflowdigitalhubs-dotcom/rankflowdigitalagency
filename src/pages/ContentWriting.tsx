    ...
    <>
      ...
      <section className="container-x py-20">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div className="reveal">
            ...
            <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">What Is SEO Content Writing?</h2>
        ...
        <div className="container-x relative">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="order-1 lg:order-2 reveal">
              ...
              <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Why High-Quality Content Matters</h2>
              ...
              <ul className="mt-6 space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-200"><strong>Higher Google rankings</strong> — well-optimized content ranks for target keywords and stays there</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-200"><strong>More organic traffic</strong> — every ranking piece becomes a permanent traffic source</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-200"><strong>Better user engagement</strong> — content that answers questions keeps visitors on your site longer</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-200"><strong>More leads</strong> — educated visitors who trust your expertise become qualified leads</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-500/20 text-brand-300"><ArrowRight className="h-4 w-4" /></span>
                  <span className="text-slate-200"><strong>Increased conversions</strong> — persuasive content guides readers toward taking action</span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-slate-200"><strong>Stronger brand authority</strong> — consistent, valuable content positions you as the expert in your field</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container-x relative">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="reveal">
              ...
              <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Blog Writing</h2>
              <div className="mt-6 space-y-4 text-slate-300 leading-relaxed">
                <p>
      ...
      <section className="container-x py-20">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div className="order-1 lg:order-2 reveal">
            <span className="eyebrow">Core Service</span>
            <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Website Content & Copywriting</h2>
            <div className="mt-6 space-y-4 text-slate-300 leading-relaxed">
              <p>
      ...
      <section className="relative overflow-hidden py-20">
        ...
        <div className="container-x relative">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="reveal">
              <span className="eyebrow">Core Service</span>
              <h2 className="mt-4 text-3xl font-bold text-white sm:text-4xl">Content Strategy & Optimization</h2>
              <div className="mt-6 space-y-4 text-slate-300 leading-relaxed">
                <p>
