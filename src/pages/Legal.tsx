...
export function PrivacyPolicy() {
  return (
    <LegalLayout title="Privacy Policy" breadcrumb={[{ name: 'Home', path: '/' }, { name: 'Privacy Policy', path: '/privacy-policy' }]}>
      ...
      <p>Rank Flow Digital ("we", "us", "our") respects your privacy and is committed to protecting your personal data. This privacy policy explains what information we collect, how we use it, and the choices you have. This policy applies to our website and all <Link to="/services" className="text-brand-300 hover:text-brand-200">services</Link> provided by Rank Flow Digital. If you have any questions after reading this policy, please <Link to="/contact" className="text-brand-300 hover:text-brand-200">contact us</Link> directly.</p>
      <h2>Information We Collect</h2>
      <p>We collect information you provide directly to us when you fill out our <Link to="/contact" className="text-brand-300 hover:text-brand-200">contact form</Link>, request a free SEO audit, or engage our services. This may include your name, email address, phone number, company name, website URL, and any details you share in your message. We also collect basic analytics data such as pages visited, time spent on our site, browser type, device information, and referring websites. This data helps us understand how visitors use our site so we can improve the experience.</p>
      <h2>How We Use Your Information</h2>
      <p>We use the information we collect for the following purposes:</p>
      <ul>
        <li>To respond to your inquiries and provide the <Link to="/seo" className="text-brand-300 hover:text-brand-200">SEO</Link>, <Link to="/content-writing" className="text-brand-300 hover:text-brand-200">content writing</Link>, or <Link to="/website-design" className="text-brand-300 hover:text-brand-200">web design</Link> services you request.</li>
      ...
      <h2>Contact Us</h2>
      <p>If you have any questions, concerns, or requests regarding this privacy policy or your personal data, please contact us at info@rankflowagency.online or visit our <Link to="/contact" className="text-brand-300 hover:text-brand-200">contact page</Link>. We are committed to resolving any issues promptly and transparently.</p>
    </LegalLayout>
  );
}
...
export function Terms() {
  return (
    <LegalLayout title="Terms & Conditions" breadcrumb={[{ name: 'Home', path: '/' }, { name: 'Terms', path: '/terms' }]}>
      ...
      <p>By using this website or engaging the services of Rank Flow Digital, you agree to the following terms and conditions. These terms govern your use of our website and all <Link to="/services" className="text-brand-300 hover:text-brand-200">services</Link> we provide, including <Link to="/seo" className="text-brand-300 hover:text-brand-200">SEO</Link>, <Link to="/content-writing" className="text-brand-300 hover:text-brand-200">content writing</Link>, <Link to="/website-design" className="text-brand-300 hover:text-brand-200">web design</Link>, and related digital marketing services. If you do not agree with these terms, please do not use our website or engage our services. We encourage you to review these terms periodically as they may be updated from time to time.</p>
      <h2>Services</h2>
      <p>Rank Flow Digital provides SEO, content writing, web design, <Link to="/link-building" className="text-brand-300 hover:text-brand-200">link building</Link>, and related digital marketing services. The specific scope, deliverables, timelines, and pricing for each engagement are defined in a separate project agreement, proposal, or statement of work. We reserve the right to modify or discontinue any service offering at any time. For details on our pricing, please visit our <Link to="/pricing" className="text-brand-300 hover:text-brand-200">pricing page</Link>. Any custom services or packages not listed on our website will be documented in a written agreement before work begins.</p>
      ...
      <p>All content, designs, code, and materials created by Rank Flow Digital for a client project transfer to the client upon full payment of all outstanding invoices. Until full payment is received, Rank Flow Digital retains ownership of all deliverables. Client-provided materials, including but not limited to logos, images, text, and brand assets, remain the property of the client. We reserve the right to showcase completed work in our <Link to="/portfolio" className="text-brand-300 hover:text-brand-200">portfolio</Link> and <Link to="/case-studies" className="text-brand-300 hover:text-brand-200">case studies</Link> unless otherwise agreed in writing. Our website content, including text, graphics, logos, and design elements, is owned by Rank Flow Digital and may not be reproduced without permission.</p>
      <h2>Payment Terms</h2>
      <p>Invoices are due per the terms stated on each invoice, typically within 15 days of issuance unless otherwise agreed. <Link to="/monthly-seo-management" className="text-brand-300 hover:text-brand-200">Monthly retainer services</Link> are billed in advance at the beginning of each billing cycle. One-time project fees are typically billed as 50% upfront and 50% upon completion, unless a different structure is agreed in the project proposal. Late payments may incur additional fees or result in a pause of services. We accept payment via bank transfer, credit card, and other methods specified on our invoices.</p>
      <h2>No Guarantees</h2>
      <p>SEO and digital marketing results depend on many factors outside our control, including search engine algorithm changes, competitor activity, market conditions, and client cooperation. We do not guarantee specific rankings, traffic levels, lead volumes, or revenue outcomes. What we do guarantee is a rigorous, transparent, and ethical process using industry best practices. Our <Link to="/seo-audit" className="text-brand-300 hover:text-brand-200">SEO audit services</Link> and ongoing campaigns are designed to maximize your potential, but results vary by industry, competition, and starting point. Any claims or case studies presented on our website represent individual results and are not indicative of future performance.</p>
      ...
      <h2>Contact</h2>
      <p>Questions about these terms? Email info@rankflowagency.online or visit our <Link to="/contact" className="text-brand-300 hover:text-brand-200">contact page</Link>. We are happy to clarify any aspect of these terms before you engage our services.</p>
    </LegalLayout>
  );
}
